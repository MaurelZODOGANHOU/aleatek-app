...
function Fiche({data, setData}) {
    ...
    return data && (
        <>
            ...
            {success && <Flash type={"success"} setFlash={setSuccess}>Modification effectuée avec success</Flash>}
            <div className='m-1'>
                {!action ? <Button action={()=>{
                    setAction(true);
                    enregistrer();
                }}>Sauvegarder</Button> : <span className='text-green-600'>Operation en cours de traitement</span> }
            </div>
